        ...
        for root, _, files in os.walk(parquet_dir):
            for file in files:
                if file.endswith('.parquet'):
                    ...
                    s3_key = f'SIH/RD{estado}{str(ano)[-2:]}{mes}.parquet/{file}'
...
with DAG(
    ...
    for estado, ano, mes in itertools.product(estados, anos,meses):
        ...
        baixar_arquivos_task = PythonOperator(
            ...
            op_kwargs={'parquet_dir':  f'/home/jamilsonfs/airflow/dags/SIH/tmp/PARQUET/RD{estado}{str(ano)[-2:]}{mes}.parquet',
                'estado': estado,
                'ano': ano,
                'mes': mes}
        )
        ...
        drop_columns_task = PythonOperator(
            ...
            op_kwargs={
                'parquet_dir': f'/home/jamilsonfs/airflow/dags/SIH/tmp/PARQUET/RD{estado}{str(ano)[-2:]}{mes}.parquet',
