...
def baixar_arquivos_e_registrar_atlas(parquet_dir, estado, ano, mes, **kwargs):
    try:
        ...
        prefix = f'sia-parquet/ATD/ATD{estado}{str(ano)[-2:]}{mes}.parquet/'
        ...
        for root, _, files in os.walk(parquet_dir):
            for file in files:
                if file.endswith('.parquet'):
                    ...
                    s3_key = f'SIA/ATD/ATD{estado}{str(ano)[-2:]}{mes}.parquet/{file}'
...
with DAG(
    ...
    for estado, ano, mes in itertools.product(estados, anos, meses):
        ...
        baixar_arquivos_task = PythonOperator(
            ...
            op_kwargs={
                'parquet_dir': f'/home/jamilsonfs/airflow/dags/SIA/tmp/PARQUET/AM{estado}{str(ano)[-2:]}{mes}.parquet',
                'estado': estado,
                'ano': ano,
                'mes': mes
            }
        ...
        renomear_columns = PythonOperator(
            ...
            op_kwargs={'parquet_dir': f'/home/jamilsonfs/airflow/dags/SIA/tmp/PARQUET/AM{estado}{str(ano)[-2:]}{mes}.parquet','json_file_path':'/home/jamilsonfs/airflow/dags/SIA/files/column_names_to_remap.json' },
        )
