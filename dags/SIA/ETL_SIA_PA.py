...
def baixar_arquivos_e_registrar_atlas(parquet_dir, estado, ano, mes, **kwargs):
    try:
        ...
        prefix = f'sia-parquet/PA/PA{estado}{str(ano)[-2:]}{mes}a.parquet/'
        ...
        for root, _, files in os.walk(parquet_dir):
            for file in files:
                if file.endswith('.parquet'):
                    ...
                    s3_key = f'SIA/PA/PA{estado}{str(ano)[-2:]}{mes}a.parquet/{file}'
...
with DAG(
    ...
    for estado, ano, mes in itertools.product(estados, anos, meses):
        ...
        baixar_arquivos_task = PythonOperator(
            ...
            op_kwargs={
                'parquet_dir': f'/home/jamilsonfs/airflow/dags/SIA/tmp/PARQUET/PA{estado}{str(ano)[-2:]}{mes}a.parquet',
                'estado': estado,
                'ano': ano,
                'mes': mes
            }
        ...
        renomear_columns = PythonOperator(
            ...
            op_kwargs={'parquet_dir': f'/home/jamilsonfs/airflow/dags/SIA/tmp/PARQUET/PA{estado}{str(ano)[-2:]}{mes}a.parquet','json_file_path':'/home/jamilsonfs/airflow/dags/SIA/files/column_names_to_remap.json' },
        )
